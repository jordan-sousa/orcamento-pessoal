...
class Bd {
    ...
    gravar(d) {
        ...
        localStorage.setItem(id, JSON.stringify(d)) // converte objeto literal em JSON
    ...
    recuperarTodosRegistro() {
        ...
        // Dessa forma vamos recuperar todas as despesas cadastrada em localStorage
        for (let i = 1; i <= id; i++) {
            
            // recuperar a despesa
            let despesa = JSON.parse(localStorage.getItem(i)) // converte JSON em objeto literal

            // existe a possibilidade de haver indices que foram puladoqremovidos
...
function cadastrarOrcamento() {
    ...
    if(despesas.validarDados()) {
        ...
        document.getElementById('modal_conteudo').innerHTML = 'Erro na gravação, verifique os compos'
...
function carregarListaDespesas() {
    ...
    despesa = bd.recuperarTodosRegistro()

    // selecionando o elemento dontbody da tabela
